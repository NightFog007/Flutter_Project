...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final String appId = Platform.isAndroid
      ? 'ca-app-pub-9010870803829618~6196712262'
      : 'ca-app-pub-9010870803829618~3900588087';

  final String bannerUnitId = Platform.isAndroid
      ? 'ca-app-pub-9010870803829618/9369670513'
      : 'ca-app-pub-9010870803829618/8330787683';
  final String screenUnitId = Platform.isAndroid
      ? 'ca-app-pub-9010870803829618/5185855256'
      : 'ca-app-pub-9010870803829618/9968137595';

  final String videoUnitId = Platform.isAndroid
      ? 'ca-app-pub-9010870803829618/7620446907'
      : 'ca-app-pub-9010870803829618/9301923180';

  //  final String appId = 'ca-app-pub-9010870803829618~6196712262';

  // final String bannerUnitId = 'ca-app-pub-9010870803829618/9369670513';

  // // final String screenUnitId =  'ca-app-pub-9010870803829618/5185855256';
  // final String screenUnitId = 'ca-app-pub-9010870803829618/5185855256';

  // final String videoUnitId = 'ca-app-pub-9010870803829618/7620446907';
