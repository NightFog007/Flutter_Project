...
final String columnName = 'tigan';
final String columnDaan = 'daan';
final String coloumXuanxiang = "xuanxiang";
final String coloumFinish = "finish";
final String coloumWrong = "wrong";
final String tableUser = 'danxuanti';
...
class Timu {
  ...
  Timu.fromMap(Map<String, dynamic> map) {
    id = map[columnId];
    tigan = map[columnName];
    daan = map[columnDaan];
    xuanxiang = map[coloumXuanxiang];
    finish = map[coloumFinish];
    wrong = map[coloumWrong];
  }
}
...
// open the database
  ...
  Future<Timu> getOne(int id, String tablename) async {
    ...
    List<Map> maps = await db.query(tablename,
        columns: ["tigan", "daan", "id", "xuanxiang"],
        // where: '$columnId = ? and $coloumFinish = 0',
        where: '$columnId = ? ',
        whereArgs: [id]);
